import {
    useFetchWhatsappTemplateQuery,useLazyFetchWhatsappTemplateByNameQuery
...
const WhatsappTemplateModal = ({ onClose, beforeRemainder, afterRemainder, templateId, onTemplateIdChange }) => {
    ...
    // Fetch templates
    const { data: templates } =  useFetchWhatsappTemplateQuery(
        { id: mgmt_id },
        { skip: !mgmt_id }
    );
    ...
    }, [templates, fetchWhatsappTemplateByName, mgmt_id]);
    ...
    const handleSelectTemplate = (templateId, type) => {
        if (type === "before") {
            ...
            if (!selectedBefore.includes(templateId)) {
            ...
            if (!selectedAfter.includes(templateId)) {
                ...
                >
                    ...
                    <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h2 className="text-md font-semibold text-gray-800">Whatsapp Template Sequence</h2>
